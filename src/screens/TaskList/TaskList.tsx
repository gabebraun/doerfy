                    ...
                    >
                      ...
                      {editingTaskId === task.id ? (
                        <InlineTaskEditor
                          value={newTaskTitle}
                          onChange={setNewTaskTitle}
                          onSave={() => handleNewTaskSave(task.id, newTaskTitle)}
                          onCancel={() => {
                            setEditingTaskId(null);
                            setNewTaskTitle('');
                          }}
                            ...
                            <DropdownMenu>
                              <DropdownMenuTrigger asChild>
                                <Button 
                                  ...
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <MoreHorizontal size={16} className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300" />
                                </Button>
                              </DropdownMenuTrigger>
